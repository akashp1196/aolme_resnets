...
def convert_ucf101_csv_to_activitynet_json(label_csv_path, train_csv_path, val_csv_path, test_csv_path, dst_json_path):
...
if __name__ == '__main__':
    ...
    for split_index in range(1, 4):
        ...
        val_csv_path = os.path.join(csv_dir_path, 'vallist0{}.txt'.format(split_index))
        ...
        convert_ucf101_csv_to_activitynet_json(label_csv_path, train_csv_path, val_csv_path, test_csv_path, dst_json_path)
